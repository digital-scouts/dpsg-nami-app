...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'de': {
      ...
      'member_list_sort_hint_group': 'Stufe',
      'member_list_sort_hint_member_time': 'Mitgliedsdauer',
      'member_list_reset_filters': 'Filter zurücksetzen',
      'member_list_last_update': 'Letztes Update: {time}',
      'member_list_last_update_now': 'Jetzt',
      'member_list_last_update_seconds': 'vor {count} Sekunden',
      ...
      'member_filter_reset': 'Zurücksetzen',
      'member_filter_apply': 'Anwenden',
      'member_filter_sort_label': 'Sortiere nach',
      'member_filter_sort_section': 'Sortierung',
      ...
      'settings_app_section_security': 'Sicherheit',
      ...
      'member_edit_edit_section_title': 'Mitglied bearbeiten',
      'member_edit_saving': 'Speichert...',
      'member_edit_saving_later': 'Speichert später...',
      'member_edit_resolution_title': 'Speicherprobleme',
      ...
      'member_edit_resolution_local_title': 'Lokal',
      'member_edit_resolution_remote_title': 'Server',
      'member_edit_resolution_current_title': 'Aktuell',
      'member_edit_resolution_previous_title': 'Vorheriger Stand',
      'member_edit_resolution_edit': 'Bearbeiten',
      'member_edit_resolution_value_label': 'Wert',
      ...
      'debug_sync_last_success': 'Letzter erfolgreicher Sync: {value}',
      'debug_sync_last_attempt': 'Letzter Versuch: {value}',
      'debug_sync_next': 'Nächster Sync: {value}',
      ...
      'debug_sync_reason_unknown': 'unbekannter Fehler',
      'debug_sync_next_wifi': 'Sobald WLAN verfügbar ist',
      'debug_sync_next_login': 'Anmeldung erforderlich',
    ...
    'en': {
      ...
      'member_list_sort_hint_group': 'Stage',
      'member_list_sort_hint_member_time': 'Membership duration',
      'member_list_reset_filters': 'Reset filters',
      'member_list_last_update': 'Last update: {time}',
      'member_list_last_update_now': 'Now',
      'member_list_last_update_seconds': '{count} seconds ago',
      ...
      'member_filter_reset': 'Reset',
      'member_filter_apply': 'Apply',
      'member_filter_sort_label': 'Sort by',
      'member_filter_sort_section': 'Sort',
      ...
      'settings_app_section_security': 'Security',
      ...
      'member_edit_edit_section_title': 'Edit member',
      'member_edit_saving': 'Saving...',
      'member_edit_saving_later': 'Saving for later...',
      'member_edit_resolution_title': 'Save issues',
      'member_edit_resolution_intro':
          'Fix the following issues to save this member.',
      'member_edit_resolution_empty':
          'All currently visible issue cases have been handled for this pass.',
      'member_edit_resolution_local_title': 'Local',
      'member_edit_resolution_remote_title': 'Server',
      'member_edit_resolution_current_title': 'Current',
      'member_edit_resolution_previous_title': 'Previous',
      'member_edit_resolution_edit': 'Edit',
      'member_edit_resolution_value_label': 'Value',
      ...
      'debug_sync_last_success': 'Last successful sync: {value}',
      'debug_sync_last_attempt': 'Last attempt: {value}',
      'debug_sync_next': 'Next sync: {value}',
      ...
      'debug_sync_reason_unknown': 'unknown error',
      'debug_sync_next_wifi': 'When Wi-Fi is available',
      'debug_sync_next_login': 'Sign-in required',
      ...
      'debug_map_cached_addresses_unavailable': 'Count currently unavailable',
      'debug_map_cached_addresses_count':
