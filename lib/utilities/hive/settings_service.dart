...
Map<String, String> getMetaGeschlechtOptions() => settingsService.getMetaGeschlechtOptions();
Map<String, String> getMetaLandOptions() => settingsService.getMetaLandOptions();
Map<String, String> getMetaBeitragsartOptions() => settingsService.getMetaBeitragsartOptions();
Map<String, String> getMetaRegionOptions() => settingsService.getMetaRegionOptions();
Map<String, String> getMetaStaatsangehoerigkeitOptions() => settingsService.getMetaStaatsangehoerigkeitOptions();
Map<String, String> getMetaKonfessionOptions() => settingsService.getMetaKonfessionOptions();
Map<String, String> getErsteTaetigkeitOptions() => settingsService.getErsteTaetigkeitOptions();
Map<String, String> getMetaMitgliedstypOptions() => settingsService.getMetaMitgliedstypOptions();
List<int> getFavouriteList() => settingsService.getFavouriteList();
bool getBiometricAuthenticationEnabled() => settingsService.getBiometricAuthenticationEnabled();
...
bool getDataLoadingOverWifiOnly() => settingsService.getDataLoadingOverWifiOnly();
...
bool getBenachrichtigungenActive() => settingsService.getBenachrichtigungenActive();
BenachrichtigungsZeit getBenachrichtigungsZeitpunkt() => settingsService.getBenachrichtigungsZeitpunkt();
List<Stufe> getGeburtstagsbenachrichtigungenGruppen() => settingsService.getGeburtstagsbenachrichtigungenGruppen();

// Setter Wrapper
void setWelcomeMessageShown(bool value) => settingsService.setWelcomeMessageShown(value);
void setNamiApiCookie(String namiApiToken) => settingsService.setNamiApiCookie(namiApiToken);
...
void setNamiPassword(String password) => settingsService.setNamiPassword(password);
void setNamiUrl(String url) => settingsService.setNamiUrl(url);
void setNamiPath(String path) => settingsService.setNamiPath(path);
void setGruppierungId(int gruppierung) => settingsService.setGruppierungId(gruppierung);
void setGruppierungName(String gruppierungName) => settingsService.setGruppierungName(gruppierungName);
void setLastNamiSync(DateTime lastNamiSync) => settingsService.setLastNamiSync(lastNamiSync);
void setLastNamiSyncTry(DateTime lastNamiSyncTry) => settingsService.setLastNamiSyncTry(lastNamiSyncTry);
void setLastLoginCheck(DateTime lastLoginCheck) => settingsService.setLastLoginCheck(lastLoginCheck);
void setDataLoadingOverWifiOnly(bool value) => settingsService.setDataLoadingOverWifiOnly(value);
void setBiometricAuthenticationEnabled(bool value) => settingsService.setBiometricAuthenticationEnabled(value);
void setRechte(List<int> rechte) => settingsService.setRechte(rechte);
void setNamiChangesEnabled(bool value) => settingsService.setNamiChangesEnabled(value);
void setLastAppVersion(String version) => settingsService.setLastAppVersion(version);
void setNewVersionInfoShown(bool value) => settingsService.setNewVersionInfoShown(value);
...
void setBenachrichtigungenActive(bool value) => settingsService.setBenachrichtigungenActive(value);
void setBenachrichtungsZeitpunkt(BenachrichtigungsZeit zeit) => settingsService.setBenachrichtungsZeitpunkt(zeit);
void setGeburtstagsbenachrichtigungenGruppen(List<Stufe> value) => settingsService.setGeburtstagsbenachrichtigungenGruppen(value);
...
void setFavouriteList(List<int> favouritList) => settingsService.setFavouriteList(favouritList);
