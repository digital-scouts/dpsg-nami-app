...
import 'package:nami/ignore_deprecated_screens/utilities/fuehrungszeugnis.widget.dart';
...
class _ProfilState extends State<Profil> {
  Tooltip _buildFeatureIcon(bool active, IconData icon, String tooltip) {
    return Tooltip(
      message: tooltip,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Center(child: Text('Profil'))),
      body: ListView(
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Bearbeiten und Erstellen von Tätigkeiten',
                  ),
                  trailing: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                ...
                ListTile(
                  title: const Text('Führungszeugnis'),
