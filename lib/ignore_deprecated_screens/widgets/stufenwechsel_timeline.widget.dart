...
/*
lege ein neues Widget an, nutze stufenwechsel_timeline als vorlage. nutze kein utilities package. Nur domain und präsentation. 

Eine Leiste in der Farbe der Stufe soll basierend auf dem Alter des Mitgleids anzeigen in welchem bereich man gerade ist. Über ein Pfeil lässt sich ablesen ob die Zeit in derstufe gerade am anfang ist oder schon den ende entgegen geht. 
Überschneiden sich die Zeiten der Stufen, dann soll die überschneidene Zeit durch eine Überblendung der Farbe (Vorherige Stufe und ggf nächste STufe) angezeigt werden.

Input: Altersgrenzen der Stufen und Mitglied
Lege dazuin domain ein 
Füge Storybook hinzu
*/
